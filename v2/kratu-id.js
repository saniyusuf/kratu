...
(function () {
  ...
  W.onerror = (e) => { console.error('KratuID worker error', e.message); };
  ...
  K.init = function () { if (K.ready) return K.ready; K.ready = call('init', { opts: { webgpu: cfg.webgpu, rec: cfg.rec } }).then(r => { K.isReady = true; K.ep = r.ep; return r; }); return K.ready; };
